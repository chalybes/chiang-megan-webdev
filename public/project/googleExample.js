...
var clientId = '186029965139-ea014dplbek4loi7bbk5eptijjmpm8id.apps.googleusercontent.com';
var apiKey = 'z7Q9GJx8BXOfI1iTsE1MaMWj';
...
function getUserInput(){
    ...
    var location = document.querySelector("#room").value;
    var eventDesc = document.querySelector("#amount").value + document.querySelector("#mline").value;

    // check input values, they should not be empty
    if (date=="" || location=="" || eventDesc=="") {
        alert("All your input fields should have a meaningful value.");
        return
    }
    else return {'date': date, 'location': location, 'eventDesc': eventDesc}
}
